...
//    private Set<Libro> itemsCarrito = new HashSet<>();
//
//    @Autowired
...
//    @ResponseBody
//    Set<Libro> obtenerLibro(@RequestParam(value = "carrito") Carrito unCarrito){
...
//    }
//
//    private Set<Libro> itemsDeCarrito(Long idCarrito){
//        Set<Libro> carrito = servicioDeSesion.obtenerUnCarrito(idCarrito);
//        return  carrito;
//    }
//}
